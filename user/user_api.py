...
from database.userservice import register_user_db, chek_user_db, add_profile_photo_db, change_user_info_db, block_user_db, unblock_user_db
...
async def register_user(data: UserRegisterModel):
    cheker = chek_user_db(data.phone_number)
